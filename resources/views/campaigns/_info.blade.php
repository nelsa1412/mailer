            <h3 class="mt-10"><span class="text-teal text-bold">{{ $campaign->subscribersCount() }}</span> {{ trans('messages.' . \Acelle\Library\Tool::getPluralPrase('recipient', $campaign->subscribers()->count())) }}</h3>
